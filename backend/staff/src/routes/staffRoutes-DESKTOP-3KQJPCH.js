...
const {addStaff,addStaffWithAgence,updateStaff,deleteStaff,getAllStaff,getParticipation,getStaffEvents,getEventStaff,getAvailabeEventStaff,addStaffToEvent,removeStaffFromEvent,getAvailableStaff,getStaffByEvent,setStaffAvailable,getAllAgencies,getAgenceTableStructure,getStaffWithAgencyByEvent,deleteStaffAndAssignments} = require('../controllers/staffController');
...
router.get('/getAvailableStaff/:event_id', getAvailableStaff);
