...
export const ServerIpAddress =
  ...
  "http://planit-alb-1132579378.us-east-1.elb.amazonaws.com:80/api";

const AuthServiceURL = `${ServerIpAddress}/auth`;
const StaffServiceURL = `http://planit-alb-1132579378.us-east-1.elb.amazonaws.com:80/api/staff`;
const EntrepriseServiceURL = `http://planit-alb-1132579378.us-east-1.elb.amazonaws.com:80/api/entreprise`;
const EventServiceURL = `http://planit-alb-1132579378.us-east-1.elb.amazonaws.com:80/api/event`;
const AccomodationServiceURL = `http://planit-alb-1132579378.us-east-1.elb.amazonaws.com:80/api/accomodation`;
const ClientServiceURL = `http://planit-alb-1132579378.us-east-1.elb.amazonaws.com:80/api/client`;
const EquipmentServiceURL = `http://planit-alb-1132579378.us-east-1.elb.amazonaws.com:80/api/equipment`;
const TransportServiceURL = `http://planit-alb-1132579378.us-east-1.elb.amazonaws.com:80/api/transport`;
const WorkshopServiceURL = `http://planit-alb-1132579378.us-east-1.elb.amazonaws.com:80/api/workshop`;
const SoireeServiceURL = `http://planit-alb-1132579378.us-east-1.elb.amazonaws.com:80/api/soiree`;  
const InstructorServiceURL = `http://planit-alb-1132579378.us-east-1.elb.amazonaws.com:80/api/instructor`;
const PrestataireServiceURL = `http://planit-alb-1132579378.us-east-1.elb.amazonaws.com:80/apiprestataire`;
const TeamServiceURL = `http://planit-alb-1132579378.us-east-1.elb.amazonaws.com:80/api/team`;
const PauseServiceURL = `http://planit-alb-1132579378.us-east-1.elb.amazonaws.com:80/api/pause`;
