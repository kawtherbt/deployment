...
function StaffPage(){
    ...
    const getAllStaff = async ()=>{
      try {
        ...
        const reponse = await fetch(`planit-alb-378717788.us-east-1.elb.amazonaws.com:80/api/staff/getAllStaff`,{
            method:"GET",
    ...
    const getParticipation = async ()=>{
      try {
        setStatus(FETCH_STATUS.LOADING);
        const reponse = await fetch(`planit-alb-378717788.us-east-1.elb.amazonaws.com:80/api/staff/getParticipation`,{
            method:"GET",
            headers:{'Content-Type':'application/json'},
            credentials:'include',
        });
