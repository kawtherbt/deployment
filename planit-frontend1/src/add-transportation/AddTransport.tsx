...
export default function AddTransport() {
  ...
  const getAgencies = async () => {
    try {
      const response = await fetch(`planit-alb-378717788.us-east-1.elb.amazonaws.com:80/api/staff/getAllAgencies`, {
        method: 'GET',
        headers: {
  ...
  const getStaff = async () => {
    try {
      ...
      console.log('API URL:', `planit-alb-378717788.us-east-1.elb.amazonaws.com:80/api/staff/getStaffByEvent/${eventId}`);
      
      const response = await fetch(`planit-alb-378717788.us-east-1.elb.amazonaws.com:80/api/staff/getStaffByEvent/${eventId}`, {
        method: 'GET',
        headers: {
          'Content-Type': 'application/json',
          'Authorization': `Bearer ${localStorage.getItem('token')}`
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      console.log('Sending request to:', `planit-alb-378717788.us-east-1.elb.amazonaws.com:80/api/transport/addTransport`);

      const response = await fetch(`planit-alb-378717788.us-east-1.elb.amazonaws.com:80/api/transport/addTransport`, {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
          'Authorization': `Bearer ${localStorage.getItem('token')}`,
