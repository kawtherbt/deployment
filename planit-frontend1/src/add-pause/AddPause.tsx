...
export default function AddPause() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const url = isEditing 
        ? `http://planit-alb-1128307560.us-east-1.elb.amazonaws.com:80/api/pause/updatePause`
        : `http://planit-alb-1128307560.us-east-1.elb.amazonaws.com:80/api/pause/addPause`;
