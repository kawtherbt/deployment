...
export default function AddWorkshop() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const response = await fetch(`http://planit-alb-1128307560.us-east-1.elb.amazonaws.com:80/api/workshop/addWorkshop`, {
        method: 'POST',
        headers: {
  ...
  const getInstructors = async () => {
    try {
      const response = await fetch(`http://planit-alb-1128307560.us-east-1.elb.amazonaws.com:80/api/instructor/getInstructorsForWorkshop`, {
        method: 'GET',
        headers: {
          'Content-Type': 'application/json',
        },
