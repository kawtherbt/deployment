...
export const ServerIpAddress = import.meta.env.VITE_API_URL?? "http://planit-alb-895528359.us-east-1.elb.amazonaws.com/api";
...
const AddCarModal: React.FC<AddCarModalProps> = ({ isOpen, onClose, getCars }) => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const response = await fetch(`http://planit-alb-1532976624.us-east-1.elb.amazonaws.com:80/api/transport/addCar`, {
        method: "POST",
