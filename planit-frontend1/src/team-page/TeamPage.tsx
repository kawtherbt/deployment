...
function TeamPage(){
    ...
    const getTeams = async () => {
        try {
            ...
            const response = await fetch(`planit-alb-378717788.us-east-1.elb.amazonaws.com:80/api/team/getAllTeams`, {
                method: "GET",
    ...
    const getStaffForTeams = async () => {
        try {
            setStatus(FETCH_STATUS.LOADING);
            const response = await fetch(`planit-alb-378717788.us-east-1.elb.amazonaws.com:80/api/team/getAllStaffForTeams`, {
                method: "GET",
                headers: { 'Content-Type': 'application/json' },
                credentials: 'include',
            });
    ...
    const deleteTeams = async (ids:number[]) => {
        try {
            console.log(ids);
            setStatus(FETCH_STATUS.LOADING);
            const response = await fetch(`planit-alb-378717788.us-east-1.elb.amazonaws.com:80/api/team/deleteTeam`, {
                method: "DELETE",
                headers: { 'Content-Type': 'application/json' },
                credentials: 'include',
